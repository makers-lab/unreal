...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				...
				MetaData->SetValue(NewProp_Location, TEXT("Category"), TEXT("Transform"));
	...
	IMPLEMENT_CLASS(USequencerTools, 3606234300);
